...
import workbenchSchema from "../../schemas/workbench/frontmatter.schema.json" with { type: "json" };
...
export const validateWorkbenchFrontmatter = ajv.compile(
  workbenchSchema,
) as ValidateFunction<Record<string, unknown>>;
export const validateWorkstreamFrontmatter = ajv.compile(
  workstreamSchema,
) as ValidateFunction<Record<string, unknown>>;
export const validateSourcePolicyV1 = ajv.compile(
  sourcePolicySchema,
) as ValidateFunction<Record<string, unknown>>;
